...
With the two splitting criteria, we can plot the predictors against cases again.
...
It is clear that splitting by date reduces the clustering behavior so that trends are now much clearer. We will keep this in mind when proceeding with the analysis. We show the plots for the other cluster for completion. The split in date corresponds to cases on and before July 25th, 2021 and cases after this date.
